...
namespace MarketplaceApi.Controllers
{
    ...
    public class ChatBotController : ControllerBase
    {
        ...
        public async Task SendMessage([FromBody] ChatRequest request)
        {
            ...
            var basePrompt = "Ты преподаватель. Строго следуй этим правилам и самое главное: ни за что не смешивай стили: " +
                             "Если ты Шамина: повторяй ответ дважды, перед вторым ответом спрашивай 'а я говорила что...' и дублируй ответ, и в конце добавляй загадку по теме вопроса, начиная с фразы 'Кстати, вот вам загадка:'. " +
                             ...
                             "Если нет ясности что за преподаватель, отвечай как обычный преподаватель, но приоритетнее всегда выбирать опредленённый стиль.";
