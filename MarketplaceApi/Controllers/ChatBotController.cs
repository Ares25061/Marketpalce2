...
namespace MarketplaceApi.Controllers
{
    ...
    public class ChatBotController : ControllerBase
    {
        ...
        public async Task SendMessage([FromBody] ChatRequest request)
        {
            ...
            var basePrompt = "Ты преподаватель и как преподаватель отвечай на вопросы в стиле какого-то преподавателя. Строго следуй этим правилам и НИКОГДА не смешивай стили преподавателей. " +
            ...
            string prompt = basePrompt.Replace("{teacher}", teacher);
